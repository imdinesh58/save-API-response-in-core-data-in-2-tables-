...
@interface SaveAPIResponseViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableVIew;
@property (nonatomic, copy) NSArray<NSManagedObject *> * _Nonnull JWED;
@property (nonatomic, copy) NSArray<NSManagedObject *> * _Nonnull JAT;
...
@property (nonatomic, strong) NSEntityDescription * _Nullable entity2;
@property (nonatomic, readonly, strong) NSFetchRequest<NSManagedObject *> * _Nonnull fetchRequest;
@property (nonatomic, readonly, strong) NSFetchRequest<NSManagedObject *> * _Nonnull fetchRequest2;
- (void)viewDidLoad;
...
- (IBAction)btnClick;
- (IBAction)manual:(id _Nonnull)sender;
- (IBAction)deleteDatas:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC17CoreDataSampleApp20ThreadViewController")
@interface ThreadViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tasksTblView;
@property (nonatomic, copy) NSArray<NSManagedObject *> * _Nonnull JAT;
@property (nonatomic, readonly, strong) NSManagedObjectContext * _Nonnull managedContext;
@property (nonatomic, strong) NSEntityDescription * _Nullable entity2;
@property (nonatomic, readonly, strong) NSFetchRequest<NSManagedObject *> * _Nonnull fetchRequest2;
